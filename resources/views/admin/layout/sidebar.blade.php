<aside class="w-1/6 h-screen" aria-label="Sidebar">
    <div class="overflow-y-auto h-screen py-4 px-3 bg-gray-100 shadow-md">
       <a href="{{ route('admin-cust-list') }}" class="flex items-center pl-2.5 mb-5">
          <img src="{{ asset('img/logoadmin.png') }}" class="mr-3 h-6 sm:h-7" alt="Logo">
       </a>
       <ul class="space-y-2">
          <li>
             <a href="{{ route('admin-cust-list') }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-200 ">
          ...
          <li>
             <a href="{{ route('admin-toko-list') }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-200 ">
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Toko List</span>
             </a>
          </li>
          <li>
