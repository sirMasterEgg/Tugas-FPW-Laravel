    ...
    <div class="flex flex-row">
        ...
        <div class="container w-5/6 p-10">
            <div class="w-full">
                ...
                <form action="{{ route('admin-cust-doedit') }}" method="POST">
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="fullname" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-persian-green-std focus:border-persian-green-std block w-full p-2.5" required="" value="{{ $data['user_fullname'] }}" placeholder="Full Name" name="fullname">
                    </div>
                    <div class="mb-6">
